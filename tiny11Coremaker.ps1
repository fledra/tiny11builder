...
elseif ($input -eq 'n') {
    Write-Output "You chose not to enable .NET 3.5. Continuing..."
}
else {
    Write-Output "Invalid input. Please enter 'y' to enable .NET 3.5 or 'n' to continue without installing .net 3.5."
}
...
elseif ($input -eq 'n') {
    ...
    Write-Output "Invalid input. Please enter 'y' to continue or 'n' to exit."
}
